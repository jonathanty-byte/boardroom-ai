            ...
            {frictions.map((f, i) => (
              <div key={i} className="dialogue-box p-3">
                ...
                {Object.entries(f.positions).map(([role, pos]) => (
                  <div key={role} className="text-[9px] text-gray-400 pl-3 border-l-2 border-gray-700 mb-1 font-[family-name:var(--font-terminal)] text-sm">
              ...
              return (
                <div key={role} className="dialogue-box p-3">
                  ...
                  {debate.status === "debating" && (
                    <div className="font-[family-name:var(--font-terminal)] text-sm text-gray-400">
                  ...
                  {debate.result && (
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="font-[family-name:var(--font-terminal)] text-sm text-gray-300 mt-1">
                        {debate.result.argument}
                      </p>
                      {debate.result.condition && (
                        <p className="font-[family-name:var(--font-terminal)] text-xs text-gray-500 italic">
            ...
            {synthesis.consensus.length > 0 && (
              <div className="dialogue-box p-3">
                ...
                {synthesis.consensus.map((c, i) => (
                  <p key={i} className="font-[family-name:var(--font-terminal)] text-xs text-gray-300 mb-1">
                    {c}
                  </p>
                ))}
              </div>
